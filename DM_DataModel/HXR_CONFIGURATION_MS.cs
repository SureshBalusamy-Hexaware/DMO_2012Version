...
namespace DM_DataModel
{
    ...
    public partial class HXR_CONFIGURATION_MS
    {
        ...
        public byte[] Database_Password { get; set; }
        public string Schema_Name { get; set; }
        public byte[] Schema_Password { get; set; }
        public long Active_Flag { get; set; }
        public string OS_Username { get; set; }
        public byte[] OS_Password { get; set; }
        public System.DateTime Create_Date { get; set; }
        public Nullable<System.DateTime> Last_Modified_Date { get; set; }
        public string Last_Modified_By { get; set; }
    
        public virtual HXR_CLIENT_MS HXR_CLIENT_MS { get; set; }
    }
}
