...
new Menu { ToolId = ((int)Tools.DataProfiler),	MenuId = 1105, ParentMenuId = 0, MenuOrderId = 5,	MenuName = "Data Outliers",  Controller="DataProfiler", Action = "CodeRuleManagement",    ActiveFlag = 1, HtmlAttribute= new htmlAttr { Selected = false, Style="width: 22%;" } },
