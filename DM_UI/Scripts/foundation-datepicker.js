    ...
    Datepicker.prototype = {
        ...
        fill: function() {
            ...
            while (prevMonth.valueOf() < nextMonth) {
                ...
                //    $.inArray(prevMonth.getUTCDay(), this.daysOfWeekDisabled) !== -1) {
                //    clsName += ' disabled1';
                //} Muthu ==> commented and changed the condition to select date with future time of today also
                    ...
                    case 'td':
                        if (target.is('.day') && !target.is('.disabled')) {
                            ...
                            if (this.viewSelect >= 2) {
                                this._setDate(UTCDate(year, month, day, hours, minutes, seconds, 0)); //Muthu only set value after selecting the mintutes.
                            }
                        }
